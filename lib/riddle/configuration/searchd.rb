...
module Riddle
  class Configuration
    class Searchd < Riddle::Configuration::Section
      def self.settings
        [
          :listen, :address, :port, :log, :binlog_path, :binlog_flush,
          :binlog_max_log_size, :query_log, :query_log_format,
          ...
          :workers, :dist_threads, :snippets_file_prefix, :collation_server,
      ...
      attr_accessor :mysql41, :http, :socket
